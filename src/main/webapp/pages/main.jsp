...
<div region="north" title="" split="false" class="mainTop">
    ...
    <div style="float:right;font-size:16px;padding-right:10px;">
        ...
        <a href="../user/logout" target="_self" style="text-decoration:none;color:#449942">退出登陆</a>
    </div>
</div>
            ...
            <li class="menuTitleLi">
                ...
                <ul>
                    <c:forEach items="${m.child }" var="f">
                        <li iconCls="icon-ok"><span><a
                                onClick="addTab('${f.functionName}','<%=APP_PATH%>/${f.functionURL }')">${f.functionName }</a></span>
                        </li>
                    </c:forEach>
                </ul>
            </li>
