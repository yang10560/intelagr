...
<div region="center" border="false" style="padding:5px;">
    <fieldset class="fieldset_common_style">
        <form id="roleform" name="roleform" method="post" action="<%=APP_PATH %>/role/list">
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        ...
                        <input type='hidden' id="jsonData" value="${jsonResult}"
                        />
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input name="roleName" value="${role.roleName}" class="easyui-textbox" style="width:200px;height:25px"
                               readonly>
                    </td>
                <tr>
                <tr>
                    ...
                    <td heigth="50px">
                        <div class="easyui-panel" style="padding:5px">
                            <ul id="authTree" class="easyui-tree"
                                data-options='data:${jsonResult},animate:true,checkbox:true'></ul>
                        </div>
                    </td>
                </tr>
                <tr height="60">
...
<script type="text/javascript">
    function save() {
        ...
        showLoading();
        Public.ajaxGet('<%=APP_PATH %>/role/saveRoleAuth', {roleCode: roleCode, funIds: funIds}, function (e) {
            hideLoading();
