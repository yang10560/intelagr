                    ...
                    <td class="table_common_td_txt_style">
                        ...
                        <select id="userType" name="userType" class="easyui-combobox" style="width:150px;height:25px"
                            ...
                            <c:forEach var="ut" items="${userTypes}">
                                <option  value="${ut.get("CodeCode")}">${ut.get("CodeValue")}</option>
                            </c:forEach>
                    ...
                    <td class="table_common_td_txt_style">
                        ...
                        <select id="companyCode" name="companyCode" class="easyui-combobox"
                            ...
                            <c:forEach items="${compnays}" var="cp">
                              <option value="${cp.companyCode}">${cp.companyName}</option>
                            </c:forEach>
                        </select>
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-combobox" id="role" name="role" style="width:150px"
                               data-options='valueField:"roleCode",textField:"text",data:[<c:forEach var="rs" items="${allRoles}">{"desc":"${rs.roleName}","roleCode":"${rs.roleCode}","selected":false,"text":"${rs.roleName}"},</c:forEach>{}],multiple:true,panelHeight:"auto"'
                               editable="false">
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                </tr>
...
<script type="text/javascript">
    ...
    function formCheck() {
        ...
        showLoading();
        Public.ajaxPost('<%=APP_PATH %>/user/addUser', JSON.stringify(a), function (e) {
            hideLoading();
            if (200 == e.status) {
